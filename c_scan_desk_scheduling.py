def cscan_disk_scheduling(initial_head, disk_size, requests):
...
# Test the C-SCAN disk scheduling algorithm
if __name__ == "__main__":
    initial_head_position = 50
    disk_size = 200
    request_queue = [82, 170, 43, 140, 24, 16, 190]

    total_movement = cscan_disk_scheduling(initial_head_position, disk_size, request_queue)
